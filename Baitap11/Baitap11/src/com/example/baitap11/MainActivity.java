...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editBosung=(EditText) findViewById(R.id.editTTbosung);
        chkdocbao=(CheckBox) findViewById(R.id.checkDB);
        chkdoccode=(CheckBox) findViewById(R.id.checkDS);
        chkdocsach=(CheckBox) findViewById(R.id.checkDC);
